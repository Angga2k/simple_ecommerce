...
import 'package:simple_ecommerce/pages/product_page.dart';
...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String trimmedUrl = url.replaceAll('http://localhost/storage/', '');
          ...
          children: [
            product.galleries.isNotEmpty
                ...
                : Container(
                    width: 215,
                    height: 150,
                    color: Colors.grey, // Placeholder if no image available
                    child: Icon(
                      Icons.image,
                      size: 50,
                      color: Colors.white,
